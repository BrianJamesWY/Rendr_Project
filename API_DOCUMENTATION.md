...
**Version:** 1.0  
**Base URL:** `https://verifyvideos.preview.emergentagent.com/api`  
...
**Example (curl):**
```bash
curl -X POST https://verifyvideos.preview.emergentagent.com/api/auth/login \
...
```html
<video controls>
  <source src="https://verifyvideos.preview.emergentagent.com/api/videos/watch/video-id" type="video/mp4">
</video>
```
...
**Example:**
```
https://verifyvideos.preview.emergentagent.com/api/showcase/BrianJames
```
...
### 1. Login
```bash
TOKEN=$(curl -s -X POST https://verifyvideos.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
