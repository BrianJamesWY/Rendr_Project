...
**Version:** 1.0  
**Base URL:** `https://rendr-platform.preview.emergentagent.com/api`  
...
**Example (curl):**
```bash
curl -X POST https://rendr-platform.preview.emergentagent.com/api/auth/login \
...
```html
<video controls>
  <source src="https://rendr-platform.preview.emergentagent.com/api/videos/watch/video-id" type="video/mp4">
</video>
```
...
**Example:**
```
https://rendr-platform.preview.emergentagent.com/api/showcase/BrianJames
```
...
### 1. Login
```bash
TOKEN=$(curl -s -X POST https://rendr-platform.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
