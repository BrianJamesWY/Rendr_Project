...
**Running at:** `https://rendr-verify-1.preview.emergentagent.com/api`
...
**Running at:** `https://rendr-verify-1.preview.emergentagent.com/verify`
...
```bash
# Register user
curl -X POST https://rendr-verify-1.preview.emergentagent.com/api/auth/register \
...
1. Go to: `https://rendr-verify-1.preview.emergentagent.com/verify`
...
2. **Test the verify page**
   - Visit: `https://rendr-verify-1.preview.emergentagent.com/verify`
   - Try code: `RND-TEST01`
   - Report any issues
...
### **Key URLs:**
- Verify Portal: `https://rendr-verify-1.preview.emergentagent.com/verify`
- Backend API: `https://rendr-verify-1.preview.emergentagent.com/api`
