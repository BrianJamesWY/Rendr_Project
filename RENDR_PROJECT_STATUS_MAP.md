...
**Running at:** `https://portfolioplus-9.preview.emergentagent.com/api`
...
**Running at:** `https://portfolioplus-9.preview.emergentagent.com/verify`
...
```bash
# Register user
curl -X POST https://portfolioplus-9.preview.emergentagent.com/api/auth/register \
...
curl -X POST https://portfolioplus-9.preview.emergentagent.com/api/videos/upload \
  -H "Authorization: Bearer YOUR_TOKEN_HERE" \
  -F "video_file=@/path/to/video.mp4" \
  -F "source=bodycam"

# Verify by code
curl -X POST https://portfolioplus-9.preview.emergentagent.com/api/verify/code \
  -H "Content-Type: application/json" \
  -d '{"verification_code":"RND-TEST01"}'
```

### **Test 2: Frontend Verify Portal**
1. Go to: `https://portfolioplus-9.preview.emergentagent.com/verify`
...
2. **Test the verify page**
   - Visit: `https://portfolioplus-9.preview.emergentagent.com/verify`
   - Try code: `RND-TEST01`
   - Report any issues
...
### **Key URLs:**
- Verify Portal: `https://portfolioplus-9.preview.emergentagent.com/verify`
- Backend API: `https://portfolioplus-9.preview.emergentagent.com/api`
