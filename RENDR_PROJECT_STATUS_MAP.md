...
**Running at:** `https://videoproof-1.preview.emergentagent.com/api`
...
**Running at:** `https://videoproof-1.preview.emergentagent.com/verify`
...
```bash
# Register user
curl -X POST https://videoproof-1.preview.emergentagent.com/api/auth/register \
...
1. Go to: `https://videoproof-1.preview.emergentagent.com/verify`
...
2. **Test the verify page**
   - Visit: `https://videoproof-1.preview.emergentagent.com/verify`
   - Try code: `RND-TEST01`
   - Report any issues
...
### **Key URLs:**
- Verify Portal: `https://videoproof-1.preview.emergentagent.com/verify`
- Backend API: `https://videoproof-1.preview.emergentagent.com/api`
