...
4. Test webhook manually:
   ```bash
   curl -X POST https://rendr-studio.preview.emergentagent.com/api/stripe/webhook \
...
```bash
# Test endpoint
curl -v https://rendr-studio.preview.emergentagent.com/api/@/BrianJames

# Test with auth
curl -H "Authorization: Bearer YOUR_TOKEN" \
     https://rendr-studio.preview.emergentagent.com/api/auth/me
```
