...
4. Test webhook manually:
   ```bash
   curl -X POST https://verify-video.preview.emergentagent.com/api/stripe/webhook \
...
```bash
# Test endpoint
curl -v https://verify-video.preview.emergentagent.com/api/@/BrianJames

# Test with auth
curl -H "Authorization: Bearer YOUR_TOKEN" \
     https://verify-video.preview.emergentagent.com/api/auth/me
```
