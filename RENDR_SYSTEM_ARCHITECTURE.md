...
**Webhook URL:** `https://vidauth-app.preview.emergentagent.com/api/stripe/webhook`
...
- **External URL:** https://vidauth-app.preview.emergentagent.com
...
**Frontend (.env):**
```
REACT_APP_BACKEND_URL=https://vidauth-app.preview.emergentagent.com
