        ...
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #f9fafb; padding: 20px; text-align: center; font-size: 12px; color: #6b7280;">
                ...
                <p style="margin: 5px 0 0 0;">
                    <a href="https://premium-content-46.preview.emergentagent.com/settings" style="color: #667eea;">Notification Settings</a>
                </p>
            </div>
        </body>
        </html>
            ...
            <div style="padding: 40px 20px;">
                ...
                <div style="background: #dbeafe; padding: 15px; border-radius: 8px; margin: 30px 0;">
                    ...
                    <p style="margin: 10px 0 0 0;">
                        <a href="https://premium-content-46.preview.emergentagent.com/pricing" style="color: #667eea; font-weight: bold;">View Plans</a>
                    </p>
                </div>
            </div>
