...
# Configuration
BASE_URL = "https://rendr-verify-1.preview.emergentagent.com/api"
...
class StripeIntegrationTester:
    ...
    def test_stripe_connect_onboard(self):
        ...
        try:
            onboard_data = {
                "return_url": "https://rendr-verify-1.preview.emergentagent.com/dashboard?stripe=success",
                "refresh_url": "https://rendr-verify-1.preview.emergentagent.com/dashboard?stripe=refresh"
            }
    ...
    def test_subscription_checkout(self, premium_folders):
        ...
        try:
            ...
            subscribe_data = {
                ...
                "success_url": "https://rendr-verify-1.preview.emergentagent.com/dashboard?payment=success",
                "cancel_url": "https://rendr-verify-1.preview.emergentagent.com/dashboard?payment=cancel"
            }
